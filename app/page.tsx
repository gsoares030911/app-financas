    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
      ...
      <header className="border-b dark:border-gray-800">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-gray-900 dark:text-white">FinançasPRO</span>
          </div>
          <div className="flex items-center gap-2">
            <ThemeToggle />
            <Link href="/login">
              <Button variant="ghost" className="dark:text-gray-200 dark:hover:bg-gray-800">Entrar</Button>
            </Link>
            <Link href="/register">
      ...
      <section className="max-w-6xl mx-auto px-4 py-24 text-center">
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <Link href="/login">
            <Button size="lg" variant="outline" className="dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800">
              Já tenho conta
            </Button>
          </Link>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-white dark:bg-gray-800 p-6 rounded-xl border dark:border-gray-700 shadow-sm">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {['Alimentação', 'Transporte', 'Moradia', 'Lazer', 'Saúde', 'Educação', 'Salário', 'Freelance', 'Outros'].map(
            (cat) => (
              <span
                key={cat}
                className="px-4 py-2 bg-blue-50 dark:bg-blue-950 text-blue-700 dark:text-blue-300 rounded-full text-sm font-medium"
              >
                {cat}
              </span>
            )
      ...
      {/* CTA */}
      <section className="bg-blue-600 dark:bg-blue-700 py-20 transition-colors">
      ...
      {/* Footer */}
      <footer className="border-t dark:border-gray-800 py-8 transition-colors">
